        ...
        >
          <Box sx={{ flex: 1, p: { xs: 3, sm: 4 } }}>
            ...
            <Typography variant="body1" color="text.secondary">
              Enter your annual activity levels to calculate your estimated carbon footprint.
              Every action counts. Small changes, big impact.
            </Typography>
          </Box>
          ...
          >
            <WbSunnyIcon
              sx={{ position: "absolute", top: 12, right: 16, fontSize: 44, color: "#FFD54F", opacity: 0.9 }}
            />
            <AirIcon
              sx={{ position: "absolute", top: 22, left: 20, fontSize: 28, color: "rgba(255,255,255,0.5)", transform: "rotate(-10deg)" }}
            />
            <ParkIcon
              sx={{ position: "absolute", bottom: 0, right: 16, fontSize: 80, color: "rgba(255,255,255,0.85)" }}
            />
            <ParkIcon
              sx={{ position: "absolute", bottom: 0, right: 80, fontSize: 56, color: "rgba(255,255,255,0.6)" }}
            />
            <LandscapeIcon
              sx={{ position: "absolute", bottom: 0, left: 0, fontSize: 84, color: "rgba(255,255,255,0.3)" }}
            />
          </Box>
        </Card>
